pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~prj.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~prj.adb");
with Ada.Exceptions;
...
package body ada_main is
   ...
   E141 : Short_Integer; pragma Import (Ada, E141, "system__fat_flt_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_prj");
